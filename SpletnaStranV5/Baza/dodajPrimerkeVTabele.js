...
async function posodobiBazo(){
    ...
    try{
        ...
        await knex('trenerji').insert([
            {TK_Uporabnik:11,ime: 'Marko', priimek: 'Krevh',telefon: 170283948, email:'markokrevh@trener.si', urnik: 'Pon: 16:00-18:00, Sre: 17:00-19:00, Pet: 16:00-18:00',OpisProfila: 'Izkušen nogometni strateg.'},
            {TK_Uporabnik:12,ime: 'Luka', priimek: 'Novak', telefon: 698457223, email:'lukanovak78@trener.si', urnik: 'Pon: 14:00-16:00, Sre: 16:00-18:00', OpisProfila: 'Trener z dolgoletnimi izkušnjami v odbojki.'},
            {TK_Uporabnik:13,ime: 'Ana', priimek: 'Kovač', telefon: 927435180, email:'anakovac53@trener.si', urnik: 'Tor: 17:00-19:00, Čet: 17:00-19:00, Sob: 10:00-12:00', OpisProfila: 'Trener z mednarodno licenco.'},
            {TK_Uporabnik:14,ime: 'Nina', priimek: 'Zupan', telefon: 362842790, email:'ninazupan12@trener.si', urnik: 'Tor: 15:00-17:00, Čet: 18:00-20:00', OpisProfila: 'Tenis trener s fokusom na tehniki.'},
            {TK_Uporabnik:15,ime: 'Marko', priimek: 'Potočnik', telefon: 419826589, email:'markopotocnik63@trener.si', urnik: 'Pon: 18:00-20:00, Sre: 18:00-20:00', OpisProfila: 'Mlad in motiviran fitnes trener.'},
            {TK_Uporabnik:16,ime: 'Sara', priimek: 'Hribar', telefon: 286492041, email:'sarahribar55@trener.si', urnik: 'Pon: 14:00-16:00, Sre: 16:00-18:00', OpisProfila: 'Strokovnjak za ekipni duh in disciplino.'},
            {TK_Uporabnik:17,ime: 'Matej', priimek: 'Krevs', telefon: 963785104, email:'matejkrevs84@trener.si', urnik: 'Tor: 15:00-17:00, Čet: 18:00-20:00', OpisProfila: 'Trener z dolgoletnimi izkušnjami v odbojki.'},
            {TK_Uporabnik:18,ime: 'Kaja', priimek: 'Kranjc', telefon: 325790846, email:'kajakranjc42@outlook.com', urnik: 'Pon: 18:00-20:00, Sre: 18:00-20:00', OpisProfila: 'Izkušen nogometni strateg.'},
            {TK_Uporabnik:19,ime: 'Žiga', priimek: 'Logar', telefon: 523804710, email:'zigalogar90@yahoo.com', urnik: 'Tor: 15:00-17:00, Čet: 18:00-20:00', OpisProfila: 'Strasten učitelj košarke.'},
            {TK_Uporabnik:20,ime: 'Tina', priimek: 'Petek', telefon: 739528163, email:'tinapetek76@gmail.com', urnik: 'Pon: 14:00-16:00, Sre: 16:00-18:00', OpisProfila: 'Zagnan boksarski mentor.'},
            {TK_Uporabnik:21,ime: 'Jure', priimek: 'Berk', telefon: 170536847, email:'jureberk98@gmail.com', urnik: 'Pon: 14:00-16:00, Sre: 16:00-18:00', OpisProfila: 'Specialist za fizično pripravo.'},
            {TK_Uporabnik:22,ime: 'Lea', priimek: 'Vidmar', telefon: 319478205, email:'leavidmar33@gmail.com', urnik: 'Tor: 17:00-19:00, Čet: 17:00-19:00', OpisProfila: 'Trenerka z energijo in znanjem za vse starosti.'},
            {TK_Uporabnik:23,ime: 'Rok', priimek: 'Oblak', telefon: 578320416, email:'rokoblak21@siol.net', urnik: 'Pon: 16:00-18:00, Pet: 18:00-20:00', OpisProfila: 'Nogometni trener z izkušnjami iz tujine.'},
            {TK_Uporabnik:24,ime: 'Maja', priimek: 'Sever', telefon: 860214379, email:'majasever62@gmail.com', urnik: 'Tor: 14:00-16:00, Sre: 17:00-19:00', OpisProfila: 'Strokovnjakinja za vadbo otrok.'},
            {TK_Uporabnik:25,ime: 'Nejc', priimek: 'Dolenc', telefon: 204967583, email:'nejcdolenc12@outlook.com', urnik: 'Sre: 15:00-17:00, Sob: 10:00-12:00', OpisProfila: 'Vedno nasmejan in potrpežljiv košarkarski trener.'},
            {TK_Uporabnik:26,ime: 'Jana', priimek: 'Remic', telefon: 671394820, email:'janaremic55@yahoo.com', urnik: 'Tor: 17:00-19:00, Čet: 17:00-19:00', OpisProfila: 'Fitnes trenerka s poudarkom na rehabilitaciji.'},
            {TK_Uporabnik:27,ime: 'Simon', priimek: 'Erjavec', telefon: 785302196, email:'simonerjavec99@gmail.com', urnik: 'Pon: 18:00-20:00, Sre: 18:00-20:00', OpisProfila: 'Motivator in mentor mladih športnikov.'},
            {TK_Uporabnik:28,ime: 'Eva', priimek: 'Mlakar', telefon: 943120578, email:'evamlakar88@gmail.com', urnik: 'Tor: 14:00-16:00, Pet: 15:00-17:00', OpisProfila: 'Specialistka za gibanje in kondicijo.'},
            {TK_Uporabnik:29,ime: 'Marko', priimek: 'Kralj', telefon: 390458126, email:'markokralj12@gmail.com', urnik: 'Tor: 18:00-20:00, Čet: 18:00-20:00', OpisProfila: 'Nogometni entuziast in strokovnjak za taktike.'},
            {TK_Uporabnik:30,ime: 'Tjaša', priimek: 'Zorko', telefon: 642397158, email:'tjasazorko67@gmail.com', urnik: 'Pon: 16:00-18:00, Sre: 17:00-19:00', OpisProfila: 'Plesna trenerka s srcem za gibanje.'},
            {TK_Uporabnik:31,ime: 'Miha', priimek: 'Žnidaršič', telefon: 132408796, email:'mihaznidar@gmail.com', urnik: 'Pon: 14:00-16:00, Sre: 18:00-20:00', OpisProfila: 'Vedno na voljo za individualni pristop.'},
            {TK_Uporabnik:32,ime: 'Petra', priimek: 'Turk', telefon: 812309456, email:'petraturk55@gmail.com', urnik: 'Tor: 15:00-17:00, Pet: 16:00-18:00', OpisProfila: 'Tenis trenerka z občutkom za napredek.'},
            {TK_Uporabnik:33,ime: 'Marko', priimek: 'Kne', telefon: 904812356, email:'markokne77@siol.net', urnik: 'Sre: 17:00-19:00, Sob: 10:00-12:00', OpisProfila: 'Fizioterapevt in osebni trener.' },
            {TK_Uporabnik:34,ime: 'Alja', priimek: 'Rebernik', telefon: 534982610, email:'aljarebernik33@yahoo.com', urnik: 'Pon: 15:00-17:00, Sre: 16:00-18:00', OpisProfila: 'Strokovnjakinja za vadbo žensk.' },
            {TK_Uporabnik:35,ime: 'Marko', priimek: 'Rupnik', telefon: 421395706, email:'markorupnik@gmail.com', urnik: 'Čet: 17:00-19:00, Sob: 9:00-11:00', OpisProfila: 'Zagrizen športni navdušenec in mentor.'},
            {TK_Uporabnik:36,ime: 'Nika', priimek: 'Perko', telefon: 739541280, email:'nikaperko@gmail.com', urnik: 'Tor: 16:00-18:00, Čet: 16:00-18:00', OpisProfila: 'Trenerka joge in sprostitve.'},
            {TK_Uporabnik:37,ime: 'Alen', priimek: 'Furlan', telefon: 873104592, email:'alenfurlan44@gmail.com', urnik: 'Sre: 17:00-19:00, Pet: 15:00-17:00', OpisProfila: 'Individualni trener z licenco UEFA B.'},
            {TK_Uporabnik:38,ime: 'Laura', priimek: 'Košir', telefon: 248163790, email:'laurakosir84@gmail.com', urnik: 'Pon: 15:00-17:00, Sre: 17:00-19:00', OpisProfila: 'Navdihujoča mentorica z empatijo.'},
            {TK_Uporabnik:39,ime: 'Igor', priimek: 'Kos', telefon: 982745610, email:'igorkos22@gmail.com', urnik: 'Tor: 18:00-20:00, Čet: 18:00-20:00', OpisProfila: 'Strokovnjak za nogometno taktiko.'},
            {TK_Uporabnik:40,ime: 'Zala', priimek: 'Benko', telefon: 312498175, email:'zalabenko76@gmail.com', urnik: 'Pon: 16:00-18:00, Pet: 16:00-18:00', OpisProfila: 'Pilates trenerka z osebnim pristopom.'},
            {TK_Uporabnik:41,ime: 'Uroš', priimek: 'Majer', telefon: 763581029, email:'urosmajer65@gmail.com', urnik: 'Sre: 16:00-18:00, Sob: 10:00-12:00', OpisProfila: 'Košarkarski strateg in motivator.'}
        ]).then(()=>{
