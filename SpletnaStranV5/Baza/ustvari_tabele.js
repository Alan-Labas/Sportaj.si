...
async function napolniBazo() {
    try {
        ...
        await knex.schema.createTable('osvezilniTokens',table => {
            table.increments('id');
            table.integer('user_id').unsigned().notNullable().references('id').inTable('Uporabniki').onDelete('CASCADE');
            table.string('hashiranToken').notNullable;
        ...
        const Sportna_Aktivnost = [
            {
                Naziv: 'Nogometna tekma',
                Opis: 'Tekma med ekipama A in B.',
                Lokacija: 'Igrišče A',
                Cena: 10,
                ProstaMesta: 20,
            ...
            {
                Naziv: 'Košarkaška tekma',
                Opis: 'Tekma med ekipama C in D.',
                Lokacija: 'Igrišče B',
                Cena: 15,
                ProstaMesta: 25,
            ...
            {
                Naziv: 'Atletski trening',
                Opis: 'Trening za atletske discipline.',
                Lokacija: 'Atletski stadion',
                Cena: 12,
                ProstaMesta: 30,
                slika: '../slike/sporti/atlettreningjfif',
                TK_TipAktivnosti: 3,
                TK_Trener: 3
            },
            {
                Naziv: 'Plavalni trening',
                Opis: 'Trening plavanja za začetnike.',
                Lokacija: 'Bazen A',
                Cena: 8,
                ProstaMesta: 15,
            ...
            {
                Naziv: 'Tenisni trening',
                Opis: 'Trening tenisa za vse ravni znanja.',
                Lokacija: 'Tenis igrišče A',
                Cena: 20,
                ProstaMesta: 10,
            ...
            {
                Naziv: 'Odbojkarski trening',
                Opis: 'Trening odbojke za začetnike.',
                Lokacija: 'Odbojkarso igrišče A',
                Cena: 10,
                ProstaMesta: 12,
                slika: '../slike/sporti/odbojka',
                TK_TipAktivnosti: 6,
                TK_Trener: 6
            },
            {
                Naziv: 'Rokometna tekma',
                Opis: 'Tekma med ekipama E in F.',
                Lokacija: 'Igrišče C',
                Cena: 10,
                ProstaMesta: 20,
                slika: '../slike/sporti/rokomet.jfif',
                TK_TipAktivnosti: 7,
                TK_Trener: 7
            },
            {
                Naziv: 'Kolesarska tura',
                Opis: 'Skupinska kolesarska tura.',
                Lokacija: 'Kolesarska steza A',
                Cena: 5,
                ProstaMesta: 8,
                slika: '../slike/sporti/kolo.jfif',
                TK_TipAktivnosti: 8,
                TK_Trener: 8
            },
            {
                Naziv: 'Boksarski trening',
                Opis: 'Trening boksa za vse ravni znanja.',
                Lokacija: 'Boksarska dvorana A',
                Cena: 15,
                ProstaMesta: 10,
                slika: '../slike/sporti/boks.jfif',
                TK_TipAktivnosti: 9,
                TK_Trener: 9
            },
            {
                Naziv: 'Golf trening',
                Opis: 'Trening golfa za začetnike.',
                Lokacija: 'Golf igrišče A',
                Cena: 25,
                ProstaMesta: 5,
                slika: '../slike/sporti/golf.jfif',
                TK_TipAktivnosti: 10,
                TK_Trener: 10
            },
        ];
        ...
        const Ocena_Trenerja = [
            ...
            {
                Komentar: 'Zelo strokoven in prijazen trener.',
                Ocena: 5,
                Datum: '2025-05-12',
                TK_Trener: 3,
                TK_Uporabnik: 13
        ...
        const Ocena_Sporta = [
            {
                Komentar: 'Super izkušnja, priporočam!',
                Ocena: 5,
                Datum: '2025-05-20',
            ...
            {
                Komentar: 'Vse pohvale za trening!',
                Ocena: 5,
                Datum: '2025-05-22',
                TK_SportnaAktivnost: 3,
                TK_Uporabnik: 13
            },
            {
                Komentar: 'Trening je bil pretežak.',
                Ocena: 3,
                Datum: '2025-05-23',
                TK_SportnaAktivnost: 4,
                TK_Uporabnik: 14
            },
            {
                Komentar: 'Odličen trener, zelo prijazen.',
                Ocena: 5,
                Datum: '2025-05-24',
                TK_SportnaAktivnost: 5,
                TK_Uporabnik: 15
            },
            {
                Komentar: 'Zelo strokoven in prijazen trener.',
            ...
            {
                Komentar: 'Zelo prijeten trening.',
                Ocena: 4,
                Datum: '2025-05-29',
                TK_SportnaAktivnost: 10,
                TK_Uporabnik: 20
            },
        ];
